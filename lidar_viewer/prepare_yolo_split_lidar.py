...
if os.path.exists("yolo_poles_lidar/images") and os.path.exists("yolo_poles_lidar/labels"):
    if len(os.listdir("yolo_poles_lidar/images")) > 0 or len(os.listdir("yolo_poles_lidar/labels")) > 0:
        print("[!] yolo_poles_lidar/images and yolo_poles_lidar/labels are not empty!")
